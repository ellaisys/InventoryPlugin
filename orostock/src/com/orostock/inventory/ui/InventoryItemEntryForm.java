...
import com.floreantpos.ui.dialog.POSMessageDialog;
 ...
 public class InventoryItemEntryForm extends BeanEditor<InventoryItem>
 {
   ...
   protected void createNewVendor()
   {
     ...
     DefaultComboBoxModel cbModel = (DefaultComboBoxModel)this.cbVendor.getModel();
   ...
   protected void createNewLocation() {
     ...
     DefaultComboBoxModel cbModel = (DefaultComboBoxModel)this.cbLocation.getModel();
   ...
   protected void createNewGroup() {
     ...
     DefaultComboBoxModel cbModel = (DefaultComboBoxModel)this.cbGroup.getModel();
 ...
 * Qualified Name:     com.orostock.inventory.ui.InventoryItemEntryForm
