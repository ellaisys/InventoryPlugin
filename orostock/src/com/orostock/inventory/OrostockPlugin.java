...
public class OrostockPlugin
  implements InventoryPlugin
{
  public AbstractAction[] getActions()
  {
    return new AbstractAction[] { new InventoryImporterAction(), new InventoryItemBrowserAction() };
  }
 ...
 * Qualified Name:     com.orostock.inventory.OrostockPlugin
